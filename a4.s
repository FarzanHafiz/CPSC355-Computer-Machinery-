...
move:	save	%sp, (-92+-20)&-8,	%sp							!function move
...
printBox:	
		save	%sp, (-92 + -20) & -8, %sp					!printBox function
...
equal:	!local variables 
		save	%sp, (-92+0)&-8, %sp						!function equal
		...
		bne 	skip
		nop
		mov		1,	%l3										!when all conditions true
