...
local_var							!taken from d2l
var(v_s,4,4*40)						!macro for array
var(i_s,4)							!macro for i
var(j_s,4)							!macro for j
var(temp_s,4)						!macro for temp size
...
testOuterFor:
	sll		%l2, 2,	%o2					!shift left twice to get i*4
